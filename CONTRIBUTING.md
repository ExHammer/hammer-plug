...
making it easier for developers to [contribute to Hammer Plug](#pull-requests).
...
your Operating System, as well as your Erlang, Elixir and Hammer Plug versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/hammer-plug

   # Navigate to the newly cloned directory
   cd hammer-plug

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/ExHammer/hammer-plug
   ```
